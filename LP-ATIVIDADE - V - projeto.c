...
void cadasCliente(struct Cliente clientes[], int *numerosclientes) {
    printf("Digite o nome do cliente que será cadastrado: ");
...
void Vender(struct Cliente clientes[], int numerosclientes, struct salgado cardapio[], int tamanho) {
    ...
    do {
        ...
        printf("Escolha o número do salgado: ");
...
void exibirTotalCompra(struct Cliente clientes[], int numerosclientes) {
    char nomedocliente[200];
    int i;
...
void exibirTotalVendas(struct Cliente clientes[], int numerosclientes) {
    ...
    do {
        ...
        switch (opcao) {
            ...
            case 3:
                ...
                break;
            case 4:
                exibirTotalCompra(clientes, numerosclientes);
                break;
            case 5:
                exibirTotalVendas(clientes, numerosclientes);
                break;
            case 0:
                printf("Saindo...\n");
                break;
